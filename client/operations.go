...
// The Operation type represents an ongoing APOLLO operation (asynchronous processing)
...
// Cancel will request that APOLLO cancels the operation (if supported)
...
// The RemoteOperation type represents an ongoing APOLLO operation between two servers
