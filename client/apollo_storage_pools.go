...
func (r *ProtocolAPOLLO) GetStoragePoolNames() ([]string, error) {
...
func (r *ProtocolAPOLLO) GetStoragePools() ([]api.StoragePool, error) {
...
func (r *ProtocolAPOLLO) GetStoragePool(name string) (*api.StoragePool, string, error) {
...
func (r *ProtocolAPOLLO) CreateStoragePool(pool api.StoragePoolsPost) error {
	if !r.HasExtension("storage") {
...
func (r *ProtocolAPOLLO) UpdateStoragePool(name string, pool api.StoragePoolPut, ETag string) error {
	// Send the request
...
func (r *ProtocolAPOLLO) DeleteStoragePool(name string) error {
	// Send the request
