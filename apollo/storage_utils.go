...
func apolloResolveMountoptions(options string) (uintptr, string) {
...
// Default permissions for folders in ${APOLLO_DIR}
...
// Detect whether APOLLO already uses the given storage pool.
func apolloUsesPool(dbObj *sql.DB, onDiskPoolName string, driver string, onDiskProperty string) (bool, string, error) {
