 ...
 * apollo fork* commands which are captured here, and take a file on the host fs
...
// This expects:
//  ./apollo forkputfile /source/path <pid> /target/path
// or
//  ./apollo forkgetfile /target/path <pid> /soruce/path <uid> <gid> <mode>
