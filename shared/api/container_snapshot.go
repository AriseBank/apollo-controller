...
// ContainerSnapshotsPost represents the fields available for a new APOLLO container snapshot
type ContainerSnapshotsPost struct {
	Name     string `json:"name" yaml:"name"`
	Stateful bool   `json:"stateful" yaml:"stateful"`
}

// ContainerSnapshotPost represents the fields required to rename/move a APOLLO container snapshot
...
// ContainerSnapshot represents a APOLLO conainer snapshot
